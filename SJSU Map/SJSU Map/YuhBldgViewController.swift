...
class YuhBldgViewController: UIViewController, CLLocationManagerDelegate {
    ...
    override func viewDidLoad() {
        ...
        var getHTTPrequest: String?{
            ...
            let destinations = "destinations=37.333647,-121.883884&"
    ...
    var engImageView: UIImageView = {
        let image = UIImage(named: "yuh.jpg")
