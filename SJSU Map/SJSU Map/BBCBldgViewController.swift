...
class BBCBldgViewController: UIViewController, CLLocationManagerDelegate {
    ...
    override func viewDidLoad() {
        ...
        address2.text = "Address: San Jose, CA 95112"
        ...
        var getHTTPrequest: String?{
            ...
            let destinations = "destinations=37.336522,-121.878752&"
    ...
    var engImageView: UIImageView = {
        let image = UIImage(named: "bbc.jpg")
