//
//  EngBldgViewController.swift
//  SJSU Map
//
//  Created by Chen, David on 11/6/15.
...
class EngBldgViewController: UIViewController, CLLocationManagerDelegate {
    ...
    override func viewDidLoad() {
        ...
        var getHTTPrequest: String?{
            ...
            let destinations = "destinations=37.337109,-121.881697&"
            ...
            return URL+origins+destinations+departTime+traffic+mode+APIKey
        }
...
//                print ("This JSON is: \(json)")
    ...
    var engImageView: UIImageView = {
        let image = UIImage(named: "coe.jpg")
